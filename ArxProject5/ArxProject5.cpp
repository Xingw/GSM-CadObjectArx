...
//-----------------------------------------------------------------------------
//- ArxProject5.cpp : Initialization functions
//-----------------------------------------------------------------------------
#include "StdAfx.h"
#include "resource.h"
#include <initguid.h>
#include "ArxProject5.h"
#include <afxdllx.h>
#include "ArxProject5_i.c"
#include "acadi_i.c"


//-----------------------------------------------------------------------------
class CArxProject5Module : public CAtlDllModuleT<CArxProject5Module> {

public :
	DECLARE_LIBID(LIBID_sadArxProject5Lib)
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_ARXPROJECT5, "{A598D377-046D-4ED7-99D7-1300A0DEC2B6}")
} ;

CArxProject5Module _AtlModule ;

//-----------------------------------------------------------------------------
//- Define the sole extension module object.
AC_IMPLEMENT_EXTENSION_MODULE(ArxProject5DLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE ArxProject5ExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		ArxProject5DLL.AttachInstance (hInstance) ;
		InitAcUiDLL () ;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		ArxProject5DLL.DetachInstance () ;
	}
